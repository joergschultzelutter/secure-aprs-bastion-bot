...
|----------------------------|-------|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `sabb_command_config_file` | `str` | `sabb_command_config.yaml` | Name of the external configuration file (generated by [`configure.py`](configure.md)) which contains the approved users and `--command-code`/`--command-script` configuration |
