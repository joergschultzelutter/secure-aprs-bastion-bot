...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ------------- |
| `--from-callsign`              | Our callsign from which we send the message                                                                                                                                         | `str`     | empty string  |
| `--passcode`                   | 5-digit numeric APRS-IS passcode                                                                                                                                                     | `str`     | empty string  |
| `--to-callsign`                | The destination callsign to which we send the message                                                                                                                               | `str`     | empty string  |
